...
(function () {
  ...
  var I18N = {
    en: {
      ...
      "unit.piece": "piece", "shop.weight": "Weight", "search.all": "All products", "search.for": "Results for",
      ...
      "how.s1": "Browse the counters", "how.s1.p": "Ten specialist counters online, with this week's offers and what's fresh today.",
    ...
    el: {
      ...
      "depts.lead": "Η αγορά είναι οργανωμένη σε δέκα εξειδικευμένα τμήματα. Επιλέξτε έναν πάγκο για να δείτε τι υπάρχει και τι να ζητήσετε.",
      ...
      "unit.piece": "τεμ.", "shop.weight": "Βάρος", "search.all": "Όλα τα προϊόντα", "search.for": "Αποτελέσματα για",
      ...
      "how.s1": "Δείτε τους πάγκους", "how.s1.p": "Δέκα εξειδικευμένοι πάγκοι online, με τις προσφορές της εβδομάδας και ό,τι είναι φρέσκο σήμερα.",
